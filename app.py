...
# --- Load data (Portuguese CSV) ---
URL_PT = "https://raw.githubusercontent.com/vqrca/dashboard_salarios_dados/main/dados-imersao-final.csv"
df = pd.read_csv(URL_PT)

# --- Data Translation ---
# The original dataset is in Portuguese (as provided by the bootcamp).
# To make the dashboard usable for a global audience, we translate:
# 1. Column names -> English
# 2. Key categorical values (e.g., Seniority, Contract Type, Work Model, Country) -> English
# This is done dynamically at load time; the CSV file remains unchanged.
...
COL_MAP = {
    ...
    "usd": "usd",
    "residencia": "country",
    "residencia_iso3": "country_iso3",  # keep ISO3 for map
